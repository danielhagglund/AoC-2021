...
course_steps = []
final_course = {"horizontal": 0, "depth": 0, "aim": 0}
...
for step in course_steps:
    if step["direction"] == "down":
        final_course["aim"] = final_course["aim"] + step["distance"]
    elif step["direction"] == "forward":
        final_course["horizontal"] = final_course["horizontal"] + step["distance"]
        final_course["depth"] = final_course["depth"] + (step["distance"] * final_course["aim"] )
